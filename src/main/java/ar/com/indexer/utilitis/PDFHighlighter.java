...
public class PDFHighlighter extends PDFTextStripper
{
    ...
    protected void endPage( PDPage pdPage ) throws IOException
    {
        ...
        // Traitement des listes  puces (caractres spciaux)
        if (page.indexOf("a") != -1)
        {
     ...
     */
    public void posiciones(String document,String[] args) throws IOException
    {
        ...
        finally
        {
            ...
            {
            	try {
					doc.save("/home/ubuntu/Escritorio/directoriosServidor/republica 7.pdf");
