...
-- Schema mydb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pdfindexer` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
-- -----------------------------------------------------
-- Schema pdfindexer
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `pdfindexer`.`users` (
  ...
  `temporal` TINYINT(1) NULL DEFAULT NULL,
  PRIMARY KEY (`USER_ID`),
...
-- -----------------------------------------------------
-- Table `pdfindexer`.`bcp`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pdfindexer`.`bcp` (
  `idbcp` INT NOT NULL AUTO_INCREMENT,
  `monto` VARCHAR(45) NULL,
  `fecha` DATE NULL,
  `users_USER_ID` INT(10) UNSIGNED NOT NULL,
  `periodo_cubierto` VARCHAR(45) NULL,
  `usado` BOOLEAN FALSE,
  PRIMARY KEY (`idbcp`),
  INDEX `fk_bcp_users_idx` (`users_USER_ID` ASC),
  CONSTRAINT `fk_bcp_users`
